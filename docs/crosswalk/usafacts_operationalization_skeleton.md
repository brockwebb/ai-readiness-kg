...
- **DP documentation gap (G1) — closed 2026-09-02:** `census-2020-disclosure-avoidance-handbook-2021` (Census Bureau, *Disclosure Avoidance for the 2020 Census: An Introduction*, Nov 2021) admitted through the standing path (batch-026, epoch `g1dp-2026-09-02`) as the G1 DP_NOISE fixture source: publishes rho / epsilon / delta and per-geography allocations beside the counts. **Open (G1):** a producer document stating a suppression rule or banded reliability flag beside worked estimates — the StatCan 12-539-X 6e text held in the corpus has neither (Seldon ResearchTask "G1 SUPPRESSION / RELIABILITY_FLAG fixture source"; task RESULT 2026-09-02).
