...
| A4 | A4 · Crawler/agent access | Cloudflare. *Cloudflare AI Crawl Control: Manage AI crawlers*. 2026. <https://developers.cloudflare.com/ai-crawl-control/features/manage-ai-crawlers/>. | `cloudflare-ai-crawl-control-manage-crawlers` |  |
...
| A4 | A4 · Crawler/agent access | M. Koster; G. Illyes; H. Zeller; L. Sassman; IETF. *RFC 9309: Robots Exclusion Protocol*. 2022. <https://www.rfc-editor.org/rfc/rfc9309>. | `rfc-9309-robots-exclusion-protocol` |  |
...
| A11-declared | A11 · Effective crawler access (declared / enforced / observed) | Cloudflare. *Cloudflare AI Crawl Control: Manage AI crawlers*. 2026. <https://developers.cloudflare.com/ai-crawl-control/features/manage-ai-crawlers/>. | `cloudflare-ai-crawl-control-manage-crawlers` |  |
| A11-declared | A11 · Effective crawler access (declared / enforced / observed) | M. Koster; G. Illyes; H. Zeller; L. Sassman; IETF. *RFC 9309: Robots Exclusion Protocol*. 2022. <https://www.rfc-editor.org/rfc/rfc9309>. | `rfc-9309-robots-exclusion-protocol` |  |
| A12 | A12 · Access policy coherence | Cloudflare. *Cloudflare AI Crawl Control: Manage AI crawlers*. 2026. <https://developers.cloudflare.com/ai-crawl-control/features/manage-ai-crawlers/>. | `cloudflare-ai-crawl-control-manage-crawlers` | the enforcing layer this indicator detects from outside |
| A12 | A12 · Access policy coherence | M. Koster; G. Illyes; H. Zeller; L. Sassman; IETF. *RFC 9309: Robots Exclusion Protocol*. 2022. <https://www.rfc-editor.org/rfc/rfc9309>. | `rfc-9309-robots-exclusion-protocol` | the declared layer's semantics |
...
| G1-D | G1-D · Uncertainty legibility (two legs, scored as a vector) | Mirel LB; Singpurwalla D; Hoppe T; Liliedahl E; Schmitt R; Weber J. *FCSM 23-02: A Framework for Data Quality: Case Studies*. 2023. <https://statspolicy.gov/assets/fcsm/files/docs/FCSM.23.02_DQ_case_studies_FINAL.pdf>. | `fcsm-23-02-a-framework-for-data-quality-case-studies` |  |
...
| A1 | A1 · Machine-readable formats | 115th Congress. *Foundations for Evidence-Based Policymaking Act of 2018 (Evidence Act)*. 2019. <https://www.govinfo.gov/app/details/PLAW-115publ435>. | `foundations-for-evidence-based-policymaking-act-of-2018-evid` | Title II, the OPEN Government Data Act, amending 44 U.S.C. 3502: paragraph 18 defines machine-readable as "data in a format that can be easily processed by a computer without human intervention while ensuring no semantic meaning is lost", and paragraph 20 requires an open Government data asset to be machine-readable and available in an open format |
| A1 | A1 · Machine-readable formats | Office of Management and Budget. *M-25-05: Phase 2 Implementation of the Evidence Act — Open Government Data Access and Management*. 2025. <https://bidenwhitehouse.archives.gov/wp-content/uploads/2025/01/M-25-05-Phase-2-Implementation-of-the-Foundations-for-Evidence-Based-Policymaking-Act-of-2018-Open-Government-Data-Access-and-Management-Guidance.pdf>. | `m-25-05-phase-2-implementation-of-the-evidence-act-open-gove` | section 5, attributes generally required for public data assets, i. Machine-Readable: "agencies must make each of their public data assets machine-readable", with the worked example that tabular data "should not provide this data as a scanned image or image-based PDF document, but rather should provide that public data asset in an appropriate format e.g. in a character-delimited format such as a CSV file" |
| A1 | A1 · Machine-readable formats | W3C Data on the Web Best Practices Working Group. *Data on the Web Best Practices (W3C Recommendation, 31 January 2017)*. 2017. <https://www.w3.org/TR/dwbp/>. | `w3c-dwbp-2017` | BP 12, use machine-readable standardized data formats: "make data available in a machine-readable, standardized data format that is well suited to its intended or potential use", implemented as "CSV, XML, HDF5, JSON and RDF serialization syntaxes" and tested by "check if the data format conforms to a known machine-readable data format specification"; and BP 14, provide data in multiple formats, the not-PDF-only half |
...
| A6 | A6 · Structured markup | Schema.org Community Group. *schema.org: Dataset*. 2026. <https://schema.org/Dataset>. | `schema-org-dataset` |  |
...
| G4 | G4 · Authority metadata | SEMIC, Interoperable Europe (European Commission). *DCAT-AP vocabulary, the r5r namespace (DCAT-AP 3.0.0 release)*. 2024. <https://semiceu.github.io/DCAT-AP/r5r/releases/3.0.0/>. | `dcat-ap-3-0-0-r5r-vocabulary` | Properties, applicable legislation, dcatap:applicableLegislation, range eli:LegalResource, cited for the statutory-mandate clause by analogy: "the legislation that is applicable to this resource." Its own specification defines applicability, the legislation a resource falls under; G4's clause is a mandate, the legislation the data are collected under, and no US standard in the corpus defines a field for either; issuing authority and statistical-versus-administrative provenance: general support; no pinpoint |
| G4 | G4 · Authority metadata | U.S. General Services Administration / Data.gov. *DCAT-US Schema v1.1 (Project Open Data Metadata Schema) - resources.data.gov*. 2026. <https://resources.data.gov/resources/dcat-us/>. | `dcat-us-1-1-schema` | Dataset Required Fields and the field definitions, which support the issuing-authority clause and define the fields RULE-G4-v1 tests: Publisher, "The publishing entity and optionally their parent organization(s)."; bureauCode, required "Yes, for United States Federal Government agencies", "Represent each bureau responsible for the dataset according to the codes found in OMB Circular A-11, Appendix C"; programCode, "Provide an array of programs related to this data asset"; statutory mandate: general support; no pinpoint — no field carries it, and the page glossary's definition of metadata, sourced to NIST, says only that "Metadata also may provide other relevant information, such as the responsible steward, associated laws and regulations, and access management policy."; statistical-versus-administrative provenance: general support; no pinpoint |
| G4 | G4 · Authority metadata | U.S. General Services Administration / Data.gov. *DCAT-US 3.0 Schema: Dataset (resources.data.gov)*. 2026. <https://resources.data.gov/standards/catalog/dcat-us-3/dataset/>. | `dcat-us-3-dataset-schema` | Dataset, publisher, Mandatory, for the issuing-authority clause: "Organization responsible for publishing and making the dataset available"; Dataset, provenance, Optional, a free-text field that can carry the statistical-versus-administrative distinction and defines no class for it: "List of statements about the lineage of a Dataset, including any changes in its ownership or custody since its creation that may be significant for its authenticity, integrity, or interpretation"; statutory mandate: general support; no pinpoint |
| G4 | G4 · Authority metadata | U.S. General Services Administration / Data.gov. *DCAT-US 3.0 Overview (resources.data.gov)*. 2026. <https://resources.data.gov/resources/dcat-us3/>. | `dcat-us-3-overview` | Changes from v1.1, Fields not in the v3.0 core schema, on the bureau and program codes RULE-G4-v1 tests: "The following fields were introduced in v1.1 specifically for U.S. federal agencies. They are not defined in the v3.0 core schema however the v3.0 schema will not reject records that include them."; statutory mandate and statistical-versus-administrative provenance: general support; no pinpoint |
| G4 | G4 · Authority metadata | Prell M; Chapman C; Adeshiyan S; Fixler D; Garin T; Mirel L; Phipps P. *FCSM 19-01: Transparent Reporting for Integrated Data Quality*. 2019. <https://statspolicy.gov/assets/fcsm/files/docs/Transparent_Reporting_FCSM_19_01_092719.pdf>. | `fcsm-19-01-transparent-reporting-for-integrated-data-quality` | §3(c), VetPop2016, Table 3.3, dimension 4 Traceability, which is the provenance-carried-as-metadata clause: "The extent to which data are well documented, verifiable, and easily attributed to a source.", assessed as "Clarity of the description of the source of a data element in documentation including metadata information."; and §1 Introduction, Types of Data, for the survey-versus-administrative distinction the clause rests on: "Government program agencies create administrative data as part of their daily operations."; statutory mandate: recorded as one agency's practice and nowhere prescribed, §5 SESTAT: "NSF has a continuing mandate most recently expressed in the America COMPETES Reauthorization Act of 2010"; issuing authority: general support; no pinpoint — the report's eight quality dimensions do not include one, and the searches are in cc_tasks/2026-09-19_g4_locators_and_progress_drift_RESULT.md §0 |
| G4 | G4 · Authority metadata | Schema.org Community Group. *schema.org: Dataset*. 2026. <https://schema.org/Dataset>. | `schema-org-dataset` | sourceOrganization, for the issuing-authority clause: "The Organization on whose behalf the creator was working."; statutory mandate and statistical-versus-administrative provenance: general support; no pinpoint |
| G4 | G4 · Authority metadata | Iwig W; Berning M; Marck P; Prell M. *Statistical Policy Working Paper 46: Data Quality Assessment Tool for Administrative Data*. 2013. <https://statspolicy.gov/assets/fcsm/files/docs/DataQualityAssessmentTool.pdf>. | `statistical-policy-working-paper-46-data-quality-assessment` | Introduction, opening paragraph, which supports the statistical-versus-administrative provenance clause and that clause only: "Unlike survey data, which are collected for statistical purposes, administrative data are collected as part of a program agency's routine operations."; and the INSTITUTIONAL ENVIRONMENT dimension definition, Initial Acquisition phase, which makes the identity of the issuing agency a quality dimension to be assessed rather than a field to be carried: "Institutional Environment refers to the credibility of the administrative agency for producing high quality and reliable administrative data."; issuing authority and statutory mandate: general support; no pinpoint — the Tool asks 43 questions and none of them asks under what authority or mandate the data are held, and its Data Dictionary Template carries File Name, Description, File Date and File Format and no authority field |
| G4 | G4 · Authority metadata | W3C Dataset Exchange Working Group. *Data Catalog Vocabulary (DCAT) - Version 3 (W3C Recommendation)*. 2024. <https://www.w3.org/TR/vocab-dcat-3/>. | `w3c-dcat-3` | §6.4.10 Property: publisher, dcterms:publisher, for the issuing-authority clause: "The entity responsible for making the resource available."; statutory mandate and statistical-versus-administrative provenance: general support; no pinpoint |
| G4 | G4 · Authority metadata | W3C. *PROV-O: The PROV Ontology (W3C Recommendation, 30 April 2013)*. 2013. <https://www.w3.org/TR/prov-o/>. | `w3c-prov-o-ontology` | prov:wasAttributedTo, the issuing-authority clause as a provenance relation: "Attribution is the ascribing of an entity to an agent."; statutory mandate and statistical-versus-administrative provenance: general support; no pinpoint |
