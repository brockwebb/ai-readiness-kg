...
| G4 | G4 · Authority metadata | U.S. General Services Administration / Data.gov. *DCAT-US 3.0 Schema: Dataset (resources.data.gov)*. 2026. <https://resources.data.gov/standards/catalog/dcat-us-3/dataset/>. | `dcat-us-3-dataset-schema` | Dataset, publisher, Mandatory, for the issuing-authority clause: "Organization responsible for publishing and making the dataset available" |
...
| G4 | G4 · Authority metadata | Schema.org Community Group. *schema.org: Dataset*. 2026. <https://schema.org/Dataset>. | `schema-org-dataset` | sourceOrganization, for the issuing-authority clause: "The Organization on whose behalf the creator was working." |
