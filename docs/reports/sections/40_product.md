...
the frame. Only {{result:scan_l0_declared_flagship_agencies_2026-09-09:value}} of
{{result:fss_agencies_tier_a:value}} bodies have had a flagship product declared for them, and
the remaining {{result:fss_agencies_pending_operator_declaration_2026-09:value}} carry a host
...
Across the {{result:scan_l0_declared_flagship_surfaces_2026-09-09:value}} declared surfaces,
{{result:scan_l0_product_legs_at_zero_2026-09-09:value}} of the
{{result:scan_l0_product_legs_2026-09-09:value}} product checks return not a single pass. None
