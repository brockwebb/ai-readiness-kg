...
| `http` | 0.1.0 | `bs4` | `classify_exception`, `classify_status`, `fetch`, `store_evidence` | A11-declared, A12, A2, A9, B3, D1, F4, G1-D | `RULE-A11-declared-v2`, `RULE-A12-v2`, `RULE-A2-v3`, `RULE-A9-v1`, `RULE-B3-v3`, `RULE-D1-v3`, `RULE-F4-v3`, `RULE-G1-D-v1` |
